    ...
    <tr class="odd">
        ...
        <td class="sorting_1">
            <div class="d-flex justify-content-start align-items-center user-name">
                ...
                <div class="d-flex flex-column"><a href="{{ url('dashboard/user/facility/profile/' . $user->uuid) }}"
        ...
        <td class="" style="">
            <div class="d-flex align-items-center">
                <a href="{{ url('dashboard/user/facility/profile/' . $user->uuid) }}" class="text-body delete-record"><i
                        class="ti ti-eye"></i></a>
