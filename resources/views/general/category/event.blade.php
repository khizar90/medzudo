                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr class="odd">
                                        ...
                                        <td><img class="rounded" src="{{ $category->image }}" alt="" width="100" height="100"></td>
                                        <td class="" style="">
                                            ...
                                            <div class="modal fade" id="edit{{ $category->id }}" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('category-edit' , $category->id) }}" enctype="multipart/form-data" id="addBusForm"
                                                            method="POST">
                                                            @csrf
                ...
                <div class="modal fade" id="addNewBus" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('category-add') }}" id="addBusForm" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="type" id="" value="event">
