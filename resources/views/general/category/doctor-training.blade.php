...
@section('title', 'Doctor Training Abilities Categories')
@section('main', 'Doctor Training Abilities Management')
@section('link')
            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <div class="d-flex justify-content-between">
                        <h5 class="card-title mb-3">Doctor Training Abilities List</h5>
                        <div class="">
                            <button class="btn btn-secondary add-new btn-primary" tabindex="0"
                                ...
                                data-bs-target="#addNewBus"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                        class="d-none d-sm-inline-block">Add New Doctor Training Abilities</span></span></button>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3 mb-3">
                        ...
                        <div class="col-md-10">
                            <div
                                ...
                                <form action="{{ route('category-add-csv','doctor-training') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                        ...
                        <table class="table border-top dataTable" id="usersTable">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th>Doctor Training Abilities</th>
                                    <th>Action</th>
                                                    ...
                                                    <div class="modal-content deleteModal verifymodal">
                                                        <div class="modal-header">
                                                            <div class="modal-title" id="modalCenterTitle">Are you sure you
                                                                want to delete
                                                                this Doctor Training Abilities?
                                                            </div>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="body">After deleting the Doctor Training Abilities you will add a
                                                                new Doctor Training Abilities</div>
                                                        </div>
                                                        <hr class="hr">
                                            ...
                                            <div class="modal fade" id="edit{{ $category->id }}" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="modalCenterTitle">Edit Doctor Training Abilities
                                                            </h5>
                                                        </div>
                                                        <form action="{{ route('category-edit' , $category->id) }}" id="addBusForm"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col mb-3">
                                                                        <label for="nameWithTitle"
                                                                            class="form-label">Doctor Training Abilities</label>
                                                                        <input type="text" id="nameWithTitle"
                                                                            name="name" value="{{ $category->name }}" class="form-control"
                                                                            placeholder="Doctor Training Abilities Name" required />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" class="btn btn-primary">Edit
                                                                    Doctor Training Abilities</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                ...
                <div class="modal fade" id="addNewBus" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Add New Doctor Training Abilities</h5>
                            </div>
                            <form action="{{ route('category-add') }}" id="addBusForm" method="POST">
                                @csrf
                                <input type="hidden" name="type" id="" value="doctor-training">

                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col mb-3">
                                            <label for="nameWithTitle" class="form-label">Doctor Training Abilities</label>
