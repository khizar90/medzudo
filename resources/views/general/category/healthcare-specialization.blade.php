                    ...
                    <div class="row mt-3 mb-3">
                        ...
                        <div class="col-md-10">
                            <div
                                ...
                                <form action="{{ route('category-add-csv', 'healthcare-specialization') }}" method="POST"
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <a href="{{ url('general/dashboard/category/sub/healthcare-sub-specialization/'.$category->id) }}"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('category-sub-create') }}" id="addBusForm" method="POST">
                                @csrf
                                <input type="hidden" name="type" id="" value="healthcare-specialization">
