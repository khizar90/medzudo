                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <a href="{{ url('general/dashboard/category/sub/hospital-sub-specialization/' . $category->id) }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                                    <div class="modal-content deleteModal verifymodal">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="body">After deleting the Specialization you will
                                                                add a
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('category-sub-create') }}" id="addBusForm" method="POST">
                                @csrf
                                <input type="hidden" name="type" id="" value="hospital-specialization">
