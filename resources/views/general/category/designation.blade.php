...
@section('title', 'Designation Categories')
@section('main', 'Designation Management')
@section('link')
            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <div class="d-flex justify-content-between">
                        <h5 class="card-title mb-3">Designation List</h5>
                        <div class="">
                            <button class="btn btn-secondary add-new btn-primary" tabindex="0"
                                ...
                                data-bs-target="#addNewBus"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                        class="d-none d-sm-inline-block">Add New Designation</span></span></button>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3 mb-3">
                        ...
                        <div class="col-md-10">
                            <div
                                ...
                                <form action="{{ route('category-add-csv', 'designation') }}" method="POST"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                                    <div class="modal-content deleteModal verifymodal">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="body">After deleting the Designation you will add
                                                                a
                                                                new Designation</div>
                                                        </div>
                                                        <hr class="hr">
                                            ...
                                            <div class="modal fade" id="edit{{ $category->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="modalCenterTitle">Edit Designation
                                                            </h5>
                                                        </div>
                ...
                <div class="modal fade" id="addNewBus" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Add New Designation</h5>
                            </div>
                            <form action="{{ route('category-add') }}" id="addBusForm" method="POST">
                                @csrf
                                <input type="hidden" name="type" id="" value="designation">

                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col mb-3">
                                            <label for="nameWithTitle" class="form-label">Designation</label>
