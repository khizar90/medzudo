...
@section('title', 'Staff Benefit')
@section('main', 'Staff Benefit Management')
@section('link')
            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <div class="d-flex justify-content-between">
                        <h5 class="card-title mb-3">Staff Benefit</h5>
                        <div class="">
                            <button class="btn btn-secondary add-new btn-primary" tabindex="0"
                                ...
                                data-bs-target="#addNewBus"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                        class="d-none d-sm-inline-block">Add New Staff Benefit</span></span></button>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3 mb-3">
                        ...
                        <div class="col-md-10">
                            <div
                                ...
                                <form action="{{ route('category-add-csv', 'staff-benefit') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div id="DataTables_Table_0_filter" class="dataTables_filter">
                                        <label>
                                            <input type="file" accept=".csv" required class="form-control"
                                                name="file" aria-controls="DataTables_Table_0">
                                        </label>
                                            ...
                                            <div class="modal fade" id="edit{{ $category->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="modalCenterTitle">Staff Benefit
                                                            </h5>
                                                        </div>
                                                        <form action="{{ route('category-edit', $category->id) }}"
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col mb-3">
                                                                        <label for="nameWithTitle" class="form-label">Staff
                                                                            Benefit</label>
                                                                        <input type="text" id="nameWithTitle"
                                                                            name="name" value="{{ $category->name }}"
                                                                            class="form-control" placeholder="Staff Benefit"
                                                                            required />
                                                                    </div>
                                                                </div>
                                                            </div>
                ...
                <div class="modal fade" id="addNewBus" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Add New Staff Benefit</h5>
                            </div>
                            <form action="{{ route('category-add') }}" id="addBusForm" method="POST">
                                @csrf
                                <input type="hidden" name="type" id="" value="staff-benefit">

                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col mb-3">
                                            <label for="nameWithTitle" class="form-label">Staff Benefit</label>
                                            <input type="text" id="nameWithTitle" name="name" class="form-control"
                                                placeholder="Staff Benefit" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary">Add Staff Benefit</button>
                                </div>
                            </form>
                        </div>
                    </div>
