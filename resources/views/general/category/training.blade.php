                    ...
                    <div class="row mt-3 mb-3">
                        ...
                        <div class="col-md-10">
                            <div
                                ...
                                <form action="{{ route('category-add-csv', 'training') }}" method="POST"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                                    <div class="modal-content deleteModal verifymodal">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="body">After deleting the Training Abilities you
                                                                will add a
                                            ...
                                            <div class="modal fade" id="edit{{ $category->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="modalCenterTitle">Edit Training
                                                                Abilities
                                                            </h5>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col mb-3">
                                                                        ...
                                                                        <input type="text" id="nameWithTitle"
                                                                            ...
                                                                            class="form-control"
                                                                            placeholder="Training Abilities Name"
                                                                            required />
                                                                    </div>
                                                                </div>
                                                            </div>
