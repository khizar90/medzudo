...
@section('title', 'Stem Profession')
@section('main', 'stem Profession Management')
@section('link')
            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <div class="d-flex justify-content-between">
                        <h5 class="card-title mb-3">Stem Profession List</h5>
                        <div class="">
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <a href="{{ url('general/dashboard/category/sub/stem-specialization/' . $category->id) }}"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('category-add') }}" id="addBusForm" method="POST">
                                @csrf
                                <input type="hidden" name="type" id="" value="stem-profession">
