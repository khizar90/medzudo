            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <div class="d-flex justify-content-between">
                        <h5 class="card-title mb-3">Reported Forum</h5>
                        <div class="">
                            ...
                            <tbody id="">
                                @foreach ($reports as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->reported_user->question }}</td>
                ...
                <div class="modal fade" data-bs-backdrop='static' id="deleteUser" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                        <div class="modal-content deleteModal verifymodal">
                            ...
                            <div class="modal-body">
                                <div class="body">After deleting the forum the forum will not acces the app
                                </div>
                            </div>
                            <hr class="hr">
    ...
    @section('script')
        ...
        <script>
            $('.deleteUser').click(function(e) {
                ...
                console.log(itemId)
                $('#deleteButton1').attr('href', "/dashboard/report/forum/delete" + "/" +
                    user_id + "/" + itemId);
