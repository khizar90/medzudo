            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <div class="d-flex justify-content-between">
                        <h5 class="card-title mb-3">Reported Facility</h5>
                        <div class="">
                                    ...
                                    <tr>
                                        <td class="sorting_1">
                                            <div class="d-flex justify-content-start align-items-center user-name">
                                                ...
                                                <div class="d-flex flex-column"><a
                                                        href="{{  url('dashboard/user/facility/profile/' . $item->user->uuid)  }}"
                                        ...
                                        <td class="sorting_1">
                                            <div class="d-flex justify-content-start align-items-center user-name">
                                                ...
                                                <div class="d-flex flex-column"><a
                                                        href="{{ url('dashboard/user/facility/profile/' . $item->reported_user->uuid) }}"
                                                        class="text-body text-truncate"><span
    ...
    @section('script')
        ...
        <script>
            $('.deleteUser').click(function(e) {
                ...
                console.log(itemId)
                $('#deleteButton1').attr('href', "/dashboard/report/facility/delete" + "/" +
                    user_id + "/" + itemId);
